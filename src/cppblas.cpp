...
namespace marlib {
  ...
  template double ddot(const csr_matrix<double,int>& x, const csr_matrix<double,int>& y);
  ...
  template double dasum(const csr_matrix<double,int>& x);

  template int iamax(const vector<double,int>& x);

  template double damax(const vector<double,int>& x);
  template double damax(const vector<double*,int>& x);
  template double damax(const dense_matrix<double,int>& x);
  template double damax(const csr_matrix<double,int>& x);
  ...
  template dense_matrix<double,int>& dgesv(
    const dense_matrix<double,int>& A, dense_matrix<double,int>& B);
  template vector<double,int>& dgesv(
    const dense_matrix<double,int>& A, vector<double,int>& B);
}
